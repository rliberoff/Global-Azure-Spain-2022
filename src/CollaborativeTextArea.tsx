...
export const CollaborativeTextArea = (props: ICollaborativeTextAreaProps) => {
    ...
    return (
      // There are a lot of different ways content can be inserted into a textarea // and not all of them trigger a onBeforeInput event. To ensure we are grabbing 
      // the correct selection before we modify the shared string we need to make sure // this.updateSelection is being called for multiple cases.
        <div>            
            <textarea
                name="editor"
                rows={40}
